export function renderLogin(container, app) {
    container.innerHTML = `
        <div class="min-h-[calc(100vh-80px)] flex items-center justify-center py-8 px-4 relative overflow-hidden bg-white">
                    ...
                    <form id="login-form" class="space-y-4">
                        <div class="space-y-1.5">
                            ...
                            <div class="relative">
                                <input type="email" name="email" required 
                                    class="h-11 pl-11 pr-4 rounded-none border-2 border-slate-200 bg-white text-sm font-medium text-sm-900 font-sans focus:outline-none focus:border-bosch-blue focus:border-l-8 focus:ring-4 focus:ring-bosch-blue/10 transition-all w-full" 
                        ...
                        <div class="flex items-center justify-between">
                            <label class="flex items-center gap-2 cursor-pointer group">
                                <input type="checkbox" class="font-sans w-4 h-4 border-2 border-slate-200 rounded-none text-sm-blue focus:ring-bosch-blue transition-all">
                        ...
                        <button type="submit" class="w-full h-11 rounded-none bg-bosch-blue text-white font-bold text-sm uppercase tracking-wider shadow-sm hover:bg-industrial-gray transition-all flex items-center justify-center gap-2 group">
                            Synchronize & Enter
...
export function renderRegister(container, app) {
    container.innerHTML = `
        <div class="min-h-[calc(100vh-80px)] flex items-center justify-center py-8 px-4 bg-white relative overflow-hidden">
            <!-- Lightning Glow Elements -->
            ...
            <div class="w-full max-w-xl relative z-10 animate-fade-in">
                <div class="bg-white rounded-none shadow-premium border-t-8 border-bosch-blue p-8 lg:p-10 space-y-6 relative overflow-hidden">
                    ...
                    <div class="absolute -top-24 -right-24 w-48 h-48 bg-bosch-blue/5 rounded-none blur-3xl"></div>
                    <div class="flex flex-col md:flex-row gap-8 items-center">
                        <div class="flex-1 space-y-4">
                            ...
                            <div class="space-y-3 pt-2">
                                <div class="flex items-center gap-2.5">
                                    ...
                                    <span class="text-sm font-medium text-slate-900 font-sans uppercase tracking-widest">Wholesale Contract Pricing</span>
                                </div>
                                <div class="flex items-center gap-2.5">
                                    <svg class="w-4 h-4 text-emerald-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg>
                                    <span class="text-sm font-medium text-slate-900 font-sans uppercase tracking-widest">Priority Stock Allocation</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <form id="register-form" class="flex-1 space-y-4">
                            <div class="space-y-1.5">
                                ...
                                <input type="text" name="name" required class="rounded-none border-2 border-slate-200 bg-white h-11 px-4 text-sm font-medium text-sm-900 font-sans focus:outline-none focus:border-bosch-blue focus:border-l-8 focus:ring-4 focus:ring-bosch-blue/10 transition-all w-full" placeholder="Full Name">
                            </div>
                            <div class="space-y-1.5">
                                <label class="text-xs font-black text-slate-500 uppercase tracking-widest ml-2">Business Email</label>
                                <input type="email" name="email" required class="rounded-none border-2 border-slate-200 bg-white h-11 px-4 text-sm font-medium text-sm-900 font-sans focus:outline-none focus:border-bosch-blue focus:border-l-8 focus:ring-4 focus:ring-bosch-blue/10 transition-all w-full" placeholder="Corporate Email">
                            </div>
                            <div class="space-y-1.5">
                                <label class="text-xs font-black text-slate-500 uppercase tracking-widest ml-2">Create Password</label>
                                <input type="password" name="password" required class="rounded-none border-2 border-slate-200 bg-white h-11 px-4 text-sm font-medium text-sm-900 font-sans focus:outline-none focus:border-bosch-blue focus:border-l-8 focus:ring-4 focus:ring-bosch-blue/10 transition-all w-full" placeholder="••••••••">
                            </div>
                            <button type="submit" class="w-full h-11 rounded-none bg-industrial-gray text-white font-bold text-sm uppercase tracking-wider shadow-sm hover:bg-bosch-blue transition-all">Submit Application</button>
