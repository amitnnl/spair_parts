...
export function renderHome(container, app) {
                ...
                <div class="max-w-7xl mx-auto px-6 lg:px-10">
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-6 items-center">
                        <div class="flex items-center gap-4 group/badge cursor-pointer">
                            <div class="text-[#ed1c24] flex-shrink-0 group-hover/badge:scale-110 transition-transform duration-300">
                                <svg class="w-8 h-8 icon-cog" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2.5">
                            ...
                            <div class="space-y-1">
                                <span class="block text-2xl font-extrabold tracking-tight leading-none text-white group-hover/badge:text-[#ed1c24] transition-colors font-poppins">10,000+</span>
                                <span class="block text-xs font-bold uppercase tracking-widest text-zinc-300">Parts Across Top Brands</span>
                            </div>
                        </div>
                        <div class="flex items-center gap-4 group/badge cursor-pointer">
                            <div class="text-[#ed1c24] flex-shrink-0 group-hover/badge:scale-110 transition-transform duration-300">
                                <svg class="w-8 h-8 icon-thumbs" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2.5">
                                    <path d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                                </svg>
                            </div>
                            <div class="space-y-1">
                                <span class="block text-2xl font-extrabold tracking-tight leading-none text-white group-hover/badge:text-[#ed1c24] transition-colors font-poppins">500+</span>
                                <span class="block text-xs font-bold uppercase tracking-widest text-zinc-300">Brands Available</span>
                            </div>
                        </div>
                        <div class="flex items-center gap-4 group/badge cursor-pointer">
                            <div class="text-[#ed1c24] flex-shrink-0 group-hover/badge:scale-110 transition-transform duration-300">
                                <svg class="w-8 h-8 icon-shield" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2.5">
                                    <path d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                                </svg>
                            </div>
                            <div class="space-y-1">
                                <span class="block text-2xl font-extrabold tracking-tight leading-none text-white group-hover/badge:text-[#ed1c24] transition-colors font-poppins">1L+</span>
                        ...
                        <div class="flex items-center gap-4 group/badge cursor-pointer">
                            ...
                            <div class="space-y-1">
                                <span class="block text-2xl font-extrabold tracking-tight leading-none text-white group-hover/badge:text-[#ed1c24] transition-colors font-poppins">99.7%</span>
                ...
                <div class="max-w-7xl mx-auto px-6 lg:px-10 reveal-element">
                    <div class="grid grid-cols-2 md:grid-cols-5 gap-8 items-start">
                        ...
                        <div class="flex items-start gap-3.5 group/badge cursor-pointer">
                            ...
                            <div class="space-y-1">
                                <span class="block text-xs font-black uppercase tracking-widest text-slate-900 group-hover/badge:text-[#ed1c24] transition-colors leading-tight">Wide Range</span>
                        ...
                        <div class="flex items-start gap-3.5 group/badge cursor-pointer">
                            ...
                            <div class="space-y-1">
                                <span class="block text-xs font-black uppercase tracking-widest text-slate-900 group-hover/badge:text-[#ed1c24] transition-colors leading-tight">Easy Lookup</span>
                        ...
                        <div class="flex items-start gap-3.5 group/badge cursor-pointer">
                            ...
                            <div class="space-y-1">
                                <span class="block text-xs font-black uppercase tracking-widest text-slate-900 group-hover/badge:text-[#ed1c24] transition-colors leading-tight">Bulk Ordering</span>
                        ...
                        <div class="flex items-start gap-3.5 group/badge cursor-pointer">
                            ...
                            <div class="space-y-1">
                                <span class="block text-xs font-black uppercase tracking-widest text-slate-900 group-hover/badge:text-[#ed1c24] transition-colors leading-tight">Secure Payments</span>
                        ...
                        <div class="flex items-start gap-3.5 group/badge cursor-pointer">
                            ...
                            <div class="space-y-1">
                                <span class="block text-xs font-black uppercase tracking-widest text-slate-900 group-hover/badge:text-[#ed1c24] transition-colors leading-tight">Pan India Delivery</span>
    ...
    // Initialize Spotlight Tracking & Scroll Reveals on Homepage
    setTimeout(() => {
        // Spotlight tracking
        ...
        // Set up mutation observer to also track dynamically loaded parts catalog cards
        ...
        homeObserver.observe(container, { childList: true, subtree: true });
