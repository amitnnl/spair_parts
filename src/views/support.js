        ...
        <div class="animate-fade-in min-h-screen bg-slate-50">
            ...
            <section class="bg-white border-b border-slate-100 py-24">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <h2 class="text-6xl font-black text-slate-900 tracking-tight mb-6 uppercase">${app.state.settings.support_title || 'Expert Support <span class="text-bosch-blue">Center</span>'}</h2>
