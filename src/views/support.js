        ...
        <div class="animate-fade-in min-h-[calc(100vh-80px)] bg-slate-50 pb-20 relative overflow-hidden">
            ...
            <section class="relative z-10 pt-20 pb-28">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <div class="inline-block px-4 py-1.5 rounded-none bg-white/10 border border-white/20 text-[10px] font-black uppercase tracking-[0.4em] text-white/90 mb-6 backdrop-blur-md">Connect with us</div>
            ...
            <section class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-20">
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    <!-- Contact Cards -->
                    <div class="space-y-6">
                        <div class="bg-white/80 backdrop-blur-xl p-8 rounded-none border border-white/50 flex flex-col items-center text-center group hover-red-glow relative overflow-hidden cursor-default shadow-sm">
                            ...
                            <div class="relative z-10">
                                <div class="w-14 h-14 rounded-none bg-slate-100 text-[#111111] flex items-center justify-center mb-5 group-hover:bg-[#ed1c24] group-hover:text-white transition-all duration-300 shadow-sm group-hover:scale-110 mx-auto">
                    ...
                    <!-- Contact Form -->
                    <div class="lg:col-span-2 bg-white/95 backdrop-blur-2xl rounded-none p-8 lg:p-10 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 relative overflow-hidden group">
                        ...
                        <div class="mb-8">
                            <h3 class="text-2xl lg:text-3xl font-black text-slate-900 tracking-tight flex items-center gap-3">
                                <span class="bg-[#ed1c24]/10 text-[#ed1c24] p-2 rounded-none">
                        ...
                        <form id="support-form" class="space-y-5">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                <div class="space-y-1.5 relative group/input">
                                    ...
                                    <input type="text" name="name" required class="font-sans w-full bg-slate-50/50 border border-slate-200 rounded-none px-4 h-12 text-sm font-medium text-sm-700 focus:outline-none focus:border-[#ed1c24] focus:ring-4 focus:ring-[#ed1c24]/10 focus:bg-white transition-all shadow-sm" placeholder="Enter your name">
                                </div>
                                <div class="space-y-1.5 relative group/input">
                                    ...
                                    <input type="email" name="email" required class="font-sans w-full bg-slate-50/50 border border-slate-200 rounded-none px-4 h-12 text-sm font-medium text-sm-700 focus:outline-none focus:border-[#ed1c24] focus:ring-4 focus:ring-[#ed1c24]/10 focus:bg-white transition-all shadow-sm" placeholder="Enter work email">
                                </div>
                                <div class="space-y-1.5 relative group/input md:col-span-2">
                                    ...
                                    <input type="tel" name="phone" required class="font-sans w-full bg-slate-50/50 border border-slate-200 rounded-none px-4 h-12 text-sm font-medium text-sm-700 focus:outline-none focus:border-[#ed1c24] focus:ring-4 focus:ring-[#ed1c24]/10 focus:bg-white transition-all shadow-sm" placeholder="Enter your contact number">
                                </div>
                                <div class="space-y-1.5 relative group/input">
                                    ...
                                    <select name="subject" class="font-sans w-full bg-slate-50/50 border border-slate-200 rounded-none px-4 h-12 text-sm font-medium text-sm-700 focus:outline-none focus:border-[#ed1c24] focus:ring-4 focus:ring-[#ed1c24]/10 focus:bg-white transition-all shadow-sm appearance-none cursor-pointer">
                                ...
                                <div class="space-y-1.5 relative group/input">
                                    ...
                                    <input type="text" name="part_no" class="font-sans w-full bg-slate-50/50 border border-slate-200 rounded-none px-4 h-12 text-sm font-medium text-sm-700 focus:outline-none focus:border-[#ed1c24] focus:ring-4 focus:ring-[#ed1c24]/10 focus:bg-white transition-all shadow-sm" placeholder="e.g. GWS 600">
                                </div>
                            </div>
                            <div class="space-y-1.5 relative group/input">
                                ...
                                <textarea name="message" required class="font-sans w-full bg-slate-50/50 border border-slate-200 rounded-none px-4 py-3 text-sm font-medium text-sm-700 focus:outline-none focus:border-[#ed1c24] focus:ring-4 focus:ring-[#ed1c24]/10 focus:bg-white transition-all min-h-[120px] resize-none shadow-sm" placeholder="Describe your technical requirement..."></textarea>
                            </div>
                            <div class="pt-2">
                                <button id="support-submit-btn" type="submit" class="w-full h-14 bg-[#111111] hover:bg-[#ed1c24] text-white rounded-none font-black text-[11px] uppercase tracking-widest shadow-lg shadow-[#111111]/20 hover:shadow-[#ed1c24]/30 transition-all duration-300 flex items-center justify-center gap-3 transform hover:-translate-y-0.5 border-2 border-transparent">
            ...
            <section class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 reveal-element">
                <div class="bg-white/95 backdrop-blur-2xl rounded-[2rem] p-6 lg:p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 relative overflow-hidden group">
                    ...
                    <div class="mb-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                        ...
                        <a href="https://maps.google.com/?q=${encodeURIComponent(contactInfo.address)}" target="_blank" class="px-5 py-2.5 bg-slate-900 hover:bg-[#ed1c24] text-white text-xs font-black uppercase tracking-widest rounded-none transition-all shadow-md shrink-0 flex items-center gap-2">
                            Open in Google Maps
                    ...
                    <div class="rounded-none overflow-hidden border border-slate-200 shadow-inner relative w-full h-[400px]">
