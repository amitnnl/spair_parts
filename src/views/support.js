                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="lg:col-span-2 bg-white rounded-none p-10 shadow-premium border-2 border-slate-100 border-t-4 border-t-bosch-blue">
                        ...
                        <form id="support-form" class="space-y-4">
                            ...
                            <button type="submit" class="w-full h-11 bg-bosch-blue text-white rounded-none font-black text-[10px] uppercase tracking-[0.2em] shadow-lg hover:bg-industrial-gray transition-colors">${supportCTA}</button>
                        </form>
                    </div>
                </div>
            </section>
