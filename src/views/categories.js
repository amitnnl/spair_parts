        ...
        <div class="animate-fade-in py-8 bg-slate-50 min-h-screen">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    ` + categories.map(c => `
                        <div onclick="app.renderCatalog(document.getElementById('view-container'))" class="bg-white rounded-none overflow-hidden group cursor-pointer transition-all duration-500 hover:-translate-y-1 ring-1 ring-slate-900/5 shadow-sm hover:shadow-md flex flex-row items-center p-3 gap-4 animate-in zoom-in duration-700">
                            ...
                            <div class="w-8 h-8 rounded-none bg-slate-50 group-hover:bg-[#ed1c24] text-slate-500 group-hover:text-white flex items-center justify-center transition-all duration-300 shrink-0 shadow-sm group-hover:shadow-red-500/30">
