                    ...
                    ${isAdmin ? `
                        <div class="space-y-1 pt-4 border-t border-slate-100">
                            ...
                            <nav class="space-y-0.5">
                                ...
                                ${renderSidebarLink('/admin/support', 'Technical Inquiries', 'M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z', active === 'support', 'slate')}
