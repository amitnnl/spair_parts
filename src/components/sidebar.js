    ...
    return `
        <aside class="w-full lg:w-72 bg-[#fdfdfd] border-r border-slate-200 flex flex-col sticky top-20 h-[calc(100vh-80px)] overflow-y-auto no-scrollbar z-20 shadow-[4px_0_24px_rgba(0,0,0,0.02)]">
            ...
            <div class="flex-1 p-6 space-y-10 overflow-y-auto mt-2">
                ...
                <div class="space-y-2">
                    <p class="text-[9px] font-black text-slate-400 uppercase tracking-[0.3em] mb-4 ml-4 opacity-60">Account Management</p>
                    <nav class="space-y-1.5">
                        ${renderSidebarLink('/profile', 'Profile Settings', 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z', active === 'profile')}
                    </nav>
                </div>
